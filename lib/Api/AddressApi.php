...
class AddressApi
{
     ...
     * @param  \WebnessStudio\MPL\Model\ZipCodeQueryRequest $body body (optional)
    ...
    {
        list($response) = $this->addressesCityToZipCodePostWithHttpInfo($x_request_id, $x_accounting_code, $body, $x_correlation_id);
        return $response;
    }
     ...
     * @param  string $x_request_id A kérés egyedi azonosítója (UUID formátumban)   /   The unique request ID (UUID format) (required)
     * @param  string $x_accounting_code Vevőkód   /   The accounting code (required)
     * @param  \WebnessStudio\MPL\Model\ZipCodeQueryRequest $body (optional)
     * @param  string $x_correlation_id Korrelációs azonosító (UUID formátumban)   /   The request correlation ID (UUID format) (optional)
     *
     * @throws \WebnessStudio\MPL\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WebnessStudio\MPL\Model\ZipCodeQueryResult, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     */
    public function addressesCityToZipCodePostAsync($x_request_id, $x_accounting_code, $body = null, $x_correlation_id = null)
    {
        return $this->addressesCityToZipCodePostAsyncWithHttpInfo($x_request_id, $x_accounting_code, $body, $x_correlation_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function addressesCityToZipCodePostRequest($x_request_id, $x_accounting_code, $body = null, $x_correlation_id = null)
    {
     ...
     * @param  string $x_request_id A kérés egyedi azonosítója (UUID formátumban)   /   The unique request ID (UUID format) (required)
     * @param  string $x_accounting_code Vevőkód   /   The accounting code (required)
     * @param  \WebnessStudio\MPL\Model\CityCodeQueryRequest $body body (optional)
     * @param  string $x_correlation_id Korrelációs azonosító (UUID formátumban)   /   The request correlation ID (UUID format) (optional)
     *
     * @throws \WebnessStudio\MPL\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->addressesZipCodeToCityPostWithHttpInfo($x_request_id, $x_accounting_code, $body, $x_correlation_id);
        return $response;
    }
     ...
     * @param  string $x_request_id A kérés egyedi azonosítója (UUID formátumban)   /   The unique request ID (UUID format) (required)
     * @param  string $x_accounting_code Vevőkód   /   The accounting code (required)
     * @param  \WebnessStudio\MPL\Model\CityCodeQueryRequest $body (optional)
     * @param  string $x_correlation_id Korrelációs azonosító (UUID formátumban)   /   The request correlation ID (UUID format) (optional)
     *
     * @throws \WebnessStudio\MPL\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WebnessStudio\MPL\Model\CityCodeQueryResult, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addressesZipCodeToCityPostAsync($x_request_id, $x_accounting_code, $body = null, $x_correlation_id = null)
    {
        return $this->addressesZipCodeToCityPostAsyncWithHttpInfo($x_request_id, $x_accounting_code, $body, $x_correlation_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function addressesZipCodeToCityPostRequest($x_request_id, $x_accounting_code, $body = null, $x_correlation_id = null)
    {
        // verify the required parameter 'x_request_id' is set
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
