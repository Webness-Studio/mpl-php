...
/**
 * NonUTF8Address Class Doc Comment
 *
 * @category Class
 * @description Alternatív címadatok (a nem csak latin betűket tartalmazó adatok itt adhatók meg, pl. kínai/cirill karakterek).\\   /   Alternative address data (data containing not only Latin characters can be entered here, e.g. Chinese/Cyrillic characters).
 * @package  WebnessStudio\MPL
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NonUTF8Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NonUTF8Address';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['address']) && (mb_strlen($this->container['address']) > 105)) {
            $invalidProperties[] = "invalid value for 'address', the character length must be smaller than or equal to 105.";
        }
    ...
    public function setPostCode($post_code)
    {
        ...
        if (!is_null($post_code) && (mb_strlen($post_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $post_code when calling NonUTF8Address., must be smaller than or equal to 20.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) > 64)) {
            throw new \InvalidArgumentException('invalid length for $city when calling NonUTF8Address., must be smaller than or equal to 64.');
        }
     ...
     * Sets address
     *
     * @param string|null $address Címadatok (utca, házszám).   /   Address data (street, house number).
     *
     * @return self
     */
    public function setAddress($address)
    {
        ...
        if (!is_null($address) && (mb_strlen($address) > 105)) {
            throw new \InvalidArgumentException('invalid length for $address when calling NonUTF8Address., must be smaller than or equal to 105.');
        }
     ...
     * Sets country_code
     *
     * @param string|null $country_code Országkód   /   Country code.
     *
     * @return self
     */
    public function setCountryCode($country_code)
    {
        ...
        if (!is_null($country_code) && (mb_strlen($country_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling NonUTF8Address., must be smaller than or equal to 3.');
        }
