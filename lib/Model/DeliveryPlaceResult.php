 ...
 */
class DeliveryPlaceResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryPlaceResult';
    ...
    protected static array $openAPINullables = [
        'deliveryplaces_query_result' => false,
    ...
    {
        $this->setIfExists('deliveryplaces_query_result', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \WebnessStudio\MPL\Model\DeliveryplacesQueryResult|null
     */
     ...
     *
     * @param \WebnessStudio\MPL\Model\DeliveryplacesQueryResult|null $deliveryplaces_query_result deliveryplaces_query_result
     *
     * @return self
     */
    public function setDeliveryplacesQueryResult($deliveryplaces_query_result)
    {
        if (is_null($deliveryplaces_query_result)) {
            throw new \InvalidArgumentException('non-nullable deliveryplaces_query_result cannot be null');
        }
