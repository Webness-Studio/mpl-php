 ...
 */
class ApiGatewayErrorResponseFault implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiGatewayErrorResponse_fault';
    ...
    {
        $this->setIfExists('faultstring', $data ?? [], null);
    ...
    */
     ...
     * Sets faultstring
     *
     * @param string|null $faultstring faultstring
     *
     * @return self
     */
    public function setFaultstring($faultstring)
    {
        if (is_null($faultstring)) {
            throw new \InvalidArgumentException('non-nullable faultstring cannot be null');
        }
     ...
     * Gets detail
     *
     * @return \WebnessStudio\MPL\Model\ApiGatewayErrorResponseFaultDetail|null
     */
     ...
     * Sets detail
     *
     * @param \WebnessStudio\MPL\Model\ApiGatewayErrorResponseFaultDetail|null $detail detail
     *
     * @return self
     */
