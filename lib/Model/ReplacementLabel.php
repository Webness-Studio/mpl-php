 ...
 */
class ReplacementLabel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReplacementLabel';
    ...
    */
     ...
     *
     * @param string|null $tracking_number A posta által kiosztott küldemény azonosító   /   The ID of the mail item delivered by Magyar Posta
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label Címirat PDF formátumban base64 enkódolva.   /   Address label in PDF format base64 encoded. format: byte
     *
     * @return self
     */
