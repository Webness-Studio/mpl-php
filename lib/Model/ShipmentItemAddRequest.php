 ...
 */
class ShipmentItemAddRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentItemAddRequest';
    ...
    protected static $openAPITypes = [
        'label_type' => 'string',
        'label_format' => 'string',
        'items' => '\WebnessStudio\MPL\Model\Item[]'
    ];
    ...
    */
     ...
     * Sets items
     *
     * @param \WebnessStudio\MPL\Model\Item[]|null $items A tételek (csomagok) felsorolása.   /   List of items (parcels).
     *
     * @return self
     */
