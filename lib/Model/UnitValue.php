 ...
 */
class UnitValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnitValue';
    ...
    */
     ...
     * Sets value
     *
     * @param int|null $value Az érték egész számként. ►DOM◄ esetén kötelező mező!   /   The value as a whole number. In case of ►DOM◄ shipment it is not nullable!
     *
     * @return self
     */
     ...
     * Sets unit
     *
     * @param string|null $unit A tömeg mértékegysége. Csak gramm fogadható el.   /   The unit of weight which can only be grams.
     *
     * @return self
     */
