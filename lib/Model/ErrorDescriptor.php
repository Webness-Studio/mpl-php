 ...
 */
class ErrorDescriptor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorDescriptor';
    ...
    */
     ...
     * Sets parameter
     *
     * @param string|null $parameter További információ (például a hibás JSON mező neve)   /   Additional information (such as the name of the invalid JSON field)
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string|null $text Szöveges hibaüzenet   /   Text error message
     *
     * @return self
     */
     ...
     * Sets text_eng
     *
     * @param string|null $text_eng Szöveges hibaüzenet angol nyelven   /   Text error message
     *
     * @return self
     */
