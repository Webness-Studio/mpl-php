...
class Recipient implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['lua_code'] = isset($data['lua_code']) ? $data['lua_code'] : null;
     ...
     * Sets lua_code
     *
     * @param string $lua_code A címzett (Lakossági Ügyfél Azonosítója) LÜA a postánál.   /   The recipient’s Retail Customer ID (Hungarian abbreviation: ‘LÜA’) with Magyar Posta.
     *
     * @return $this
     */
     ...
     * Sets disabled
     *
     * @param bool $disabled Fogyatékkal élők esetén kell megadni csomagautomatára való kézbesítéskor.   /   To be provided for disabled people when delivering to a parcel terminal.
     *
     * @return $this
     */
