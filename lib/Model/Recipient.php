...
class Recipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'address' => '\WebnessStudio\MPL\Model\DeliveryAddress',
        'lua_code' => 'string',
        'disabled' => 'bool'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('lua_code', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['lua_code']) && (mb_strlen($this->container['lua_code']) > 20)) {
            $invalidProperties[] = "invalid value for 'lua_code', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['lua_code']) && (mb_strlen($this->container['lua_code']) < 1)) {
            $invalidProperties[] = "invalid value for 'lua_code', the character length must be bigger than or equal to 1.";
        }
     ...
     * Gets address
     *
     * @return \WebnessStudio\MPL\Model\DeliveryAddress
     */
     ...
     * Sets address
     *
     * @param \WebnessStudio\MPL\Model\DeliveryAddress $address address
     *
     * @return self
     */
    ...
    {
        return $this->container['lua_code'];
    }

    /**
     * Sets lua_code
     *
     * @param string|null $lua_code A címzett (Lakossági Ügyfél Azonosítója) LÜA a postánál.   /   The recipient’s Retail Customer ID (Hungarian abbreviation: ‘LÜA’) with Magyar Posta.
     *
     * @return self
     */
    public function setLuaCode($lua_code)
    {
        if (is_null($lua_code)) {
            array_push($this->openAPINullablesSetToNull, 'lua_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lua_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($lua_code) && (mb_strlen($lua_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $lua_code when calling Recipient., must be smaller than or equal to 20.');
        }
        if (!is_null($lua_code) && (mb_strlen($lua_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $lua_code when calling Recipient., must be bigger than or equal to 1.');
        }

        $this->container['lua_code'] = $lua_code;
     ...
     * Sets disabled
     *
     * @param bool|null $disabled Fogyatékkal élők esetén kell megadni csomagautomatára való kézbesítéskor.   /   To be provided for disabled people when delivering to a parcel terminal.
     *
     * @return self
     */
