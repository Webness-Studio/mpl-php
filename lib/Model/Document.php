...
class Document implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('authorisation_nr', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['authorisation_nr']) && (mb_strlen($this->container['authorisation_nr']) > 64)) {
            $invalidProperties[] = "invalid value for 'authorisation_nr', the character length must be smaller than or equal to 64.";
        }
     ...
     *
     * @param string|null $authorisation_nr Engedélyszám / Authorisation number
     *
     * @return self
     */
    public function setAuthorisationNr($authorisation_nr)
    {
        if (is_null($authorisation_nr)) {
            array_push($this->openAPINullablesSetToNull, 'authorisation_nr');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('authorisation_nr', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($authorisation_nr) && (mb_strlen($authorisation_nr) > 64)) {
            throw new \InvalidArgumentException('invalid length for $authorisation_nr when calling Document., must be smaller than or equal to 64.');
        }
     ...
     * Sets name
     *
     * @param string|null $name Dokumentum neve / Document name
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Document., must be smaller than or equal to 64.');
        }
