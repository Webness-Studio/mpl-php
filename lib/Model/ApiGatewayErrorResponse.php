...
/**
 * ApiGatewayErrorResponse Class Doc Comment
 *
 * @category Class
 * @package  WebnessStudio\MPL
 * @author   OpenAPI Generator team
 ...
 */
class ApiGatewayErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiGatewayErrorResponse';
    ...
    protected static $openAPITypes = [
        'fault' => '\WebnessStudio\MPL\Model\ApiGatewayErrorResponseFault'
    ];
    ...
    {
        $this->setIfExists('fault', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets fault
     *
     * @return \WebnessStudio\MPL\Model\ApiGatewayErrorResponseFault|null
     */
     ...
     * Sets fault
     *
     * @param \WebnessStudio\MPL\Model\ApiGatewayErrorResponseFault|null $fault fault
     *
     * @return self
     */
    ...
    {
        if (is_null($fault)) {
            throw new \InvalidArgumentException('non-nullable fault cannot be null');
        }
