...
class Contact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['phone']) && (mb_strlen($this->container['phone']) > 14)) {
            $invalidProperties[] = "invalid value for 'phone', the character length must be smaller than or equal to 14.";
        }

        if (!is_null($this->container['organization']) && (mb_strlen($this->container['organization']) > 120)) {
            $invalidProperties[] = "invalid value for 'organization', the character length must be smaller than or equal to 120.";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Contact., must be smaller than or equal to 150.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Contact., must be bigger than or equal to 2.');
        }
     ...
     * Sets email
     *
     * @param string|null $email Érvényes email cím.    /   Valid e-mail address.
     *
     * @return self
     */
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 60)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Contact., must be smaller than or equal to 60.');
        }
        if (!is_null($email) && (mb_strlen($email) < 6)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Contact., must be bigger than or equal to 6.');
        }
     ...
     * Sets phone
     *
     * @param string|null $phone A telefonszámnak magyarnak kell lennie E.164 formátumban: +36(1|20|30|70|...)1234567   /   The phone number must be in Hungarian, in E.164 format: +36(1|20|30|70|...)1234567
     *
     * @return self
     */
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (mb_strlen($phone) > 14)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling Contact., must be smaller than or equal to 14.');
        }
     ...
     * Sets organization
     *
     * @param string|null $organization Szervezet   /   Organization
     *
     * @return self
     */
    public function setOrganization($organization)
    {
        ...
        if (!is_null($organization) && (mb_strlen($organization) > 120)) {
            throw new \InvalidArgumentException('invalid length for $organization when calling Contact., must be smaller than or equal to 120.');
        }
        if (!is_null($organization) && (mb_strlen($organization) < 1)) {
            throw new \InvalidArgumentException('invalid length for $organization when calling Contact., must be bigger than or equal to 1.');
        }
