 ...
 */
class LabelQueryResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LabelQueryResult';
    ...
    */
     ...
     *
     * @param string|null $tracking_number A postai azonosító (ragszám).
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label A base64 kódolt PDF formátumú címirat.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param \WebnessStudio\MPL\Model\ErrorDescriptor[]|null $errors A kérés végrehajtása során észlelt hibák. Amennyiben van hibalista, úgy az adott kérés sikertelenül zárult.
     *
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param \WebnessStudio\MPL\Model\WarningDescriptor[]|null $warnings A kérés végrehajtása során észlelt hiányosságok. Amennyiben a lista tartalmaz elemet, úgy az adott kérés sikeresen zárult.
     *
     * @return self
     */
