...
class ShipmentItem implements ModelInterface, ArrayAccess
{
     ...
     * Sets custom_data1
     *
     * @param string $custom_data1 Tetszőleges ügyféladat (pl. ügyfél oldali azonosító).   /   Any customer data.
     *
     * @return $this
     */
     ...
     * Sets custom_data2
     *
     * @param string $custom_data2 Tetszőleges ügyféladat (pl. ügyfél oldali azonosító).   /   Any customer data.
     *
     * @return $this
     */
     ...
     * Sets fee
     *
     * @param double $fee Feladási díj   /   Postage fee format
     *
     * @return $this
     */
     ...
     * Sets qr_code
     *
     * @param string $qr_code A címiraton megjelenő ügyféladatokat tartalmazó QR kód tartalma   /   Content of the QR code containing the customer details appearing on the address label.
     *
     * @return $this
     */
     ...
     * Sets customs
     *
     * @param \WebnessStudio\MPL\Model\Custom[] $customs Árutartalom listája
     *
     * @return $this
     */
     ...
     * Sets documents
     *
     * @param \WebnessStudio\MPL\Model\Document[] $documents Dokumentumok listája
     *
     * @return $this
     */
