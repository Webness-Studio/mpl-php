...
class DeliveryAddress implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['parcel_pickup_site'] = isset($data['parcel_pickup_site']) ? $data['parcel_pickup_site'] : null;
     ...
     *
     * @param string $parcel_pickup_site ►DOM◄ Postapont/csomagautomata/postahely neve, amennyiben oda kérik a szállítást. Ebben az esetben is meg kell adni a címzett címét.   /   Name of PostaPoint/parcel terminal/postal outlet, if delivery is requested there. In this case, the recipient's address must also be provided.
     *
     * @return $this
     */
     ...
     * Sets country_code
     *
     * @param string $country_code Országkód
     *
     * @return $this
     */
