 ...
 *
 * @category Class
 * @description Címzetti cím   /   Recipient&#39;s address
 * @package  WebnessStudio\MPL
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class DeliveryAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'city' => 'city',
        'address' => 'address',
        'parcel_pickup_site' => 'parcelPickupSite',
        'remark' => 'remark',
    ...
    protected static $setters = [
        ...
        'city' => 'setCity',
        'address' => 'setAddress',
        'parcel_pickup_site' => 'setParcelPickupSite',
        'remark' => 'setRemark',
    ...
    protected static $getters = [
        ...
        'city' => 'getCity',
        'address' => 'getAddress',
        'parcel_pickup_site' => 'getParcelPickupSite',
        'remark' => 'getRemark',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('parcel_pickup_site', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['parcel_pickup_site']) && (mb_strlen($this->container['parcel_pickup_site']) > 60)) {
            $invalidProperties[] = "invalid value for 'parcel_pickup_site', the character length must be smaller than or equal to 60.";
        }

        if (!is_null($this->container['parcel_pickup_site']) && (mb_strlen($this->container['parcel_pickup_site']) < 3)) {
            $invalidProperties[] = "invalid value for 'parcel_pickup_site', the character length must be bigger than or equal to 3.";
        }
     ...
     * Sets post_code
     *
     * @param string $post_code ►INT◄ MaxLength: 10 \\  Irányítószám   /   Postcode
     *
     * @return self
     */
    public function setPostCode($post_code)
    {
        ...
        if ((mb_strlen($post_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $post_code when calling DeliveryAddress., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($post_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $post_code when calling DeliveryAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) < 2)) {
            throw new \InvalidArgumentException('invalid length for $city when calling DeliveryAddress., must be bigger than or equal to 2.');
        }
     ...
     * Sets address
     *
     * @param string $address ►INT◄ MaxLength: 64 \\  Az utca és házszám.   /   Street and house number.
     *
     * @return self
     */
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) > 60)) {
            throw new \InvalidArgumentException('invalid length for $address when calling DeliveryAddress., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address when calling DeliveryAddress., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets parcel_pickup_site
     *
     * @return string|null
     */
    public function getParcelPickupSite()
    {
        return $this->container['parcel_pickup_site'];
    }

    /**
     * Sets parcel_pickup_site
     *
     * @param string|null $parcel_pickup_site ►DOM◄ Postapont/csomagautomata/postahely neve, amennyiben oda kérik a szállítást. Ebben az esetben is meg kell adni a címzett címét.   /   Name of PostaPoint/parcel terminal/postal outlet, if delivery is requested there. In this case, the recipient's address must also be provided.
     *
     * @return self
     */
    public function setParcelPickupSite($parcel_pickup_site)
    {
        if (is_null($parcel_pickup_site)) {
            array_push($this->openAPINullablesSetToNull, 'parcel_pickup_site');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('parcel_pickup_site', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($parcel_pickup_site) && (mb_strlen($parcel_pickup_site) > 60)) {
            throw new \InvalidArgumentException('invalid length for $parcel_pickup_site when calling DeliveryAddress., must be smaller than or equal to 60.');
        }
        if (!is_null($parcel_pickup_site) && (mb_strlen($parcel_pickup_site) < 3)) {
            throw new \InvalidArgumentException('invalid length for $parcel_pickup_site when calling DeliveryAddress., must be bigger than or equal to 3.');
        }

        $this->container['parcel_pickup_site'] = $parcel_pickup_site;
    ...
    public function setRemark($remark)
    {
        ...
        if (!is_null($remark) && (mb_strlen($remark) > 50)) {
            throw new \InvalidArgumentException('invalid length for $remark when calling DeliveryAddress., must be smaller than or equal to 50.');
        }
     ...
     * Sets country_code
     *
     * @param string|null $country_code Országkód
     *
     * @return self
     */
